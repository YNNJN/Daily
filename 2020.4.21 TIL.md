...
4. 나이가 30이면서 성이 김씨인 사람의 인원 수
   ...
   * `OR` 연산을 하기 위해서는 `Q` 오브젝트가 필요하다.
     ...
     >  If you need to execute more complex queries (for example, queries with `OR` statements), you can use [`Q objects`](https://docs.djangoproject.com/en/3.0/ref/models/querysets/#django.db.models.Q).
     >
     > A [`Q object`](https://docs.djangoproject.com/en/3.0/ref/models/querysets/#django.db.models.Q) (`django.db.models.Q`) is an object used to encapsulate a collection of keyword arguments. These keyword arguments are specified as in “Field lookups” above.
